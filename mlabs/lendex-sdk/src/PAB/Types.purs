...
type ContractPath = { contractPath :: String }
...
type ContractInstanceRef =
  ...
  , csContractDefinition :: ContractPath
...
instance decodeJsonHaskellUnit :: A.DecodeJson HaskellUnit where
  decodeJson = A.caseJsonArray (Left $ A.TypeMismatch "expected []")
    (\array -> case array of
      [] -> Right HaskellUnit
      _  -> Left $ A.TypeMismatch "expected empty []"
      )
