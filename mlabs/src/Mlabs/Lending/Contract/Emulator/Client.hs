...
callUserAct lid wal act = do
  ...
  void $ case act of
    Types.DepositAct{..}             -> callEndpoint' hdl $ Api.Deposit act'amount (unAssetClass act'asset)
    Types.BorrowAct{..}              -> callEndpoint' hdl $ Api.Borrow  act'amount (unAssetClass act'asset) (Api.toInterestRateFlag act'rate)
    Types.RepayAct{..}               -> callEndpoint' hdl $ Api.Repay   act'amount (unAssetClass act'asset) (Api.toInterestRateFlag act'rate)
    Types.SwapBorrowRateModelAct{..} -> callEndpoint' hdl $ Api.SwapBorrowRateModel (unAssetClass act'asset) (Api.toInterestRateFlag act'rate)
    ...
    types.WithdrawAct{..}            -> callEndpoint' hdl $ Api.Withdraw act'amount (unAssetClass act'asset)
