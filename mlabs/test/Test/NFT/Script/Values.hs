...
import Mlabs.NFT.Types (Content (..), NftAppInstance (..), NftAppSymbol (..), 
  NftId (..))
...
appInstance = 
  NftAppInstance testStateAddr (Value.AssetClass 
    ("00a6b45b792d07aa2a778d84c49c6a0d0c0b2bf80d6c1c16accdbe01", 
    "Unique App Token"))
